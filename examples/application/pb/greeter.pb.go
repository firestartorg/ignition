...
var file_greeter_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x86, 0x01, 0x0a, 0x07, 0x47, 0x72, 0x65, 0x65,
	...
	0x79, 0x22, 0x00, 0x12, 0x3b, 0x0a, 0x05, 0x50, 0x61, 0x6e, 0x69, 0x63, 0x12, 0x18, 0x2e, 0x68,
...
var file_greeter_proto_depIdxs = []int32{
	...
	0, // 1: helloworld.Greeter.Panic:input_type -> helloworld.HelloRequest
	1, // 2: helloworld.Greeter.SayHello:output_type -> helloworld.HelloReply
	1, // 3: helloworld.Greeter.Panic:output_type -> helloworld.HelloReply
